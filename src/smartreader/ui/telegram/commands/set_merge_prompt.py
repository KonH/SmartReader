...
class TelegramSetMergePromptCommand(SetMergePromptCommand):
    ...
    def execute(self) -> None:
        ...
        apply_prompt_change(self._tg, sender_id, lambda: self._set_merge_prompt_and_restart(prompt))
