...
class TelegramSetClusterPromptCommand(SetClusterPromptCommand):
    ...
    def execute(self) -> None:
        ...
        apply_prompt_change(self._tg, sender_id, lambda: self._set_cluster_prompt_and_restart(prompt))
